...
{
    public partial class sjv_frmGestionar_CargoUsuario : Form
    {
        public sjv_frmGestionar_CargoUsuario()
        {
            InitializeComponent();
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = N_Usuarios.Ingresar_Cargo_Usuario(this.txtbNombre.Text, this.txbDescripcion.Text);
                }
                if (Rpta.Equals("OK"))
                {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id = Int32.Parse(this.lblIDCargoUsuario.Text.ToString());
